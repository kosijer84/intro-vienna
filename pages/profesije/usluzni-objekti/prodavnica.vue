...
<script setup lang="ts">
  ...
  const headerStaticInfo = reactive({
    ...
    frontTitle: 'Prodavnice',
    frontBgTitle: '',
    frontSubtitle: 'Sve prodavnice u Beču u kojima možete kupiti naše proizvode.'
  })
  ...
  useSeoMeta({
    title: () => 'Kafici',
    description: () => 'Svi kafici u Beču',
    ogTitle: () => 'Kafici',
    ogDescription: () => 'Svi kafici u Beču',
