    ...
    <div class="col-md-9">
      <div class="row row-cols-1 row-cols-md-3 g-4">
        <div
          ...
          v-for="(story, index) in allFlatStories"
          :key="index"
          class="col"
        >
          <MStoryCard
...
function getFlatStories() {
  const flatStories = FLAT_STORY
  flatStories.sort((a, b) => b.date - a.date)
  allFlatStories.value = flatStories
}
</script>
